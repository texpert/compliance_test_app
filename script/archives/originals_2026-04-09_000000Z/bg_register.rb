# archived copy of script/originals/bg_register.rb
# DO NOT EDIT - archive snapshot
...
YOUR_PEM_CERTIFICATE = File.read('hackaton_d_1/hackaton_d_1_client_signed_certifcate.crt')
YOUR_CERTIFICATES_PRIVATE_RSA_KEY = File.read('hackaton_d_1/hackaton_d_1_client_private.key')
COMPANY_NAME = "BNM TEST"
CONTACT_EMAIL = "constantink+bnm_test@saltedge.com"
####################################################
